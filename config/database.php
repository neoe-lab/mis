    ...
    */
    ...
    'connections' => [
        ...
        'hosxp' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_HOSXP', '127.0.0.1'),
            'port' => env('DB_PORT_HOSXP', '3306'),
            'database' => env('DB_DATABASE_HOSXP', 'hos'),
            'username' => env('DB_USERNAME_HOSXP', 'sa'),
            'password' => env('DB_PASSWORD_HOSXP', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
        ...
        'hdc' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_HDC', '127.0.0.1'),
            'port' => env('DB_PORT_HDC', '3306'),
